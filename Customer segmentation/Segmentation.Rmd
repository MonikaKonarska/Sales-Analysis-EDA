...
datatable(head(basketCustomerInformation, 6), rownames = FALSE, filter="top", options = list(pageLength = 6, scrollX=T) )
```
...
datatable(head(datatoAlgorythmScaled, 6), rownames = FALSE, filter="top", options = list(pageLength = 6, scrollX=T) )
```
